...
```bash
lerobot-record --robot.type=dm_arm_follower --robot.port=COM18 --robot.cameras="{wrist: {type: opencv, index_or_path: 0, width: 640, height: 480, fps: 30}, front: {type: opencv, index_or_path: 1, width: 640, height: 480, fps: 30}}" --teleop.type=dm_arm_leader --teleop.port=COM13 --display_data=true --dataset.repo_id=shenjianliang/dm_arm_test --dataset.push_to_hub=false --dataset.num_episodes=2 --dataset.episode_time_s=30 --dataset.reset_time_s=15 --dataset.single_task="Test" --dataset.push_to_hub=false
